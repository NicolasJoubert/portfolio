...
export const H1 = ({ children, className }: TypoProps) => (
  <h1
    className={cn(
      "text-5xl font-medium tracking-[-0.03em] leading-[1.1] text-foreground",
      className,
    )}
  >
    {children}
...
export const H2 = ({ children, className }: TypoProps) => (
  <h2
    className={cn(
      "text-2xl font-medium tracking-[-0.01em] text-foreground",
      className,
    )}
  >
    {children}
...
export const Body = ({ children, className }: TypoProps) => (
  <p
    className={cn("text-[15px] text-muted-foreground leading-[1.8]", className)}
  >
    {children}
  </p>
);
...
export const AccentLink = ({
  ...
  <a
    href={href}
    className={cn(
      "text-[13px] text-accent hover:opacity-80 transition-opacity",
      className,
    )}
  >
    {children}
